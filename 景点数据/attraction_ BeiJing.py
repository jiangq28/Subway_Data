...
def read_csv(filename):  #读取 旅游局等级景点名录 .csv。转换为列表list_jingdian,其中为景点 集合。
    list_jingdian = []
...
if __name__ == '__main__':
    ...
    outfile_name = 'attratcion_BeiJing.json' #在此修改 输出文件名字
    csv_name = '北京市景点.csv'  #在此修改 旅游局等级景点名录,需要”ID",""景区名称”，”等级“，“地址”，“详细介绍”五列
